...
```ruby
set :application, 'moodle_alunos'
set :repo_url, 'https://github.com/ifrsfeliz/moodle-alunos.git'

set :deploy_to, '/home/ticpfeliz/app/moodle_alunos' #ALTERAR AQUI!!!! /home/nomedoseuusuario/app/moodle_alunos
...
```console
nano ~/app/moodle_alunos/shared/config/database.yml
```
...
```console
nano ~/app/moodle_alunos/shared/config/secrets.yml
```
